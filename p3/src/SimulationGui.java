...
public class SimulationGui extends JFrame implements Constants, ActionListener, Runnable, Gui
{
    ...
    private static final ClassLoader loader = SimulationGui.class.getClassLoader();
    ...
    private void loadImages() {
        ...
        background = loadImage(tk, "background.gif", tracker);
        try {
            tracker.waitForID(0);
        } catch (InterruptedException ie) {
            System.out.println("Got interrupted while waiting for media tracker.");
        }
    }
}
